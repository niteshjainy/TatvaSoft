  ...
  let rules = {
    first_name: [
      { type: "required", message: "First name is required." },
      {
        ...
        message: "First name length must be between 2 to 50.",
      },
    ],
    last_name: [
      { type: "required", message: "Last name is required." },
      {
        type: "length",
        options: { min: 2, max: 50 },
        message: "Last name length must be between 2 to 50.",
      },
    ],
    email: [
  ...
  let rules = {
    ...
    password: [
      { type: "required", message: "Password is required." },
      {
        ...
        message: "Password length must be between 8 to 14.",
      },
    ],
  };
  errors = validator.validateModel(bodyData, rules);
  ...
  let rules = {
    current_password: [
      { type: "required", message: "Current password is required." },
      {
        type: "length",
        options: { min: 7, max: 14 },
        message: "Current password length must be between 7 to 14.",
      },
    ],
    new_password: [
      { type: "required", message: "New password is required." },
      {
        type: "length",
        options: { min: 7, max: 14 },
        message: "New password length must be between 7 to 14.",
      },
    ],
  };
  errors = validator.validateModel(bodyData, rules);
